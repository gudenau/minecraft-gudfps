...
import net.gudenau.minecraft.fps.transformer.BlockPosRemover;
import net.gudenau.minecraft.fps.transformer.ConstantPrecomputer;
import net.gudenau.minecraft.fps.transformer.ForEachRemover;
import net.gudenau.minecraft.fps.transformer.MathOptimizer;
import net.gudenau.minecraft.fps.transformer.RPmallocTransformer;
